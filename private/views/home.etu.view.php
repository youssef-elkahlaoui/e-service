<?php 
require('../private/controllers/Login.php'); 
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm"><span style="color:#1df070;">12</span> notification administrative</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm">plus de <span style="color:burlywood;">5</span>  documents par jour</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <a href="<?= ROOT ?>/students/emplois"><span class="h2 font-weight-bold mb-0">Emplois du temps</span></a>
                                        <h5 class="card-title text-uppercase text-dark mb-0"><?=$_SESSION['NIVEAU']->NomClasse?></h5>
                                    </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow"></div>
                                    </div>
                                </div>
                                <p class="mt-3 mb-0 text-sm"><span style="color:cornflowerblue;">Emplois de <?=$_SESSION['NIVEAU']->NomClasse?></span> </p>
                            </div>
                        </div>
                    </div>
                </div>
