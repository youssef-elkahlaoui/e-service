...
<style>
    .grid-item {
        background-color: #f0f0f0; /* Background color of grid items */
        padding: 20px; /* Padding inside grid items */
        border: 1px solid #ccc; /* Border around grid items */
    }
</style>
<style>
    :root {
...
<div class="container-fluid ">
	...
	<div class="row">
        <div class="col-md-6" >
		<div class="mychart m-5 p-7 shadow d-flex justify-content-center align-items-center flex-column"> 
				<canvas id="myChart"></canvas>
		</div>
        </div>
        <div class="col-md-6 p-5">
            <div class="grid-itvem">
            <div class="calendar">
        ...
        <div class="date-time-formate">
          ...
          <div class="date-time-value">
            ...
            <div class="date-formate">14 - may - 2024</div>
          </div>
        </div>
...
<script>    const ctx = document.getElementById('myChart');
  ...
  return `${month.toString().padStart(2, '0')}/${day.toString().padStart(2, '0')}`;
    ...
    // Generate labels for the current week starting from today
    const labels = [];
    for (let i = 0; i < 6; i++) {
